  ...
  return (
    <div>
      <div className="flex items-center justify-between text-xl font-bold px-8 py-5 bg-gray-300 ">
        ...
        <div className={`absolute right-0   bg-white text-gray-400 px-6 shadow-lg mt-2 duration-500 md:hidden ${open?'top-12':'-top-[600px]'}`}>
          <div className='py-5 flex flex-col items-center'>
            <img src={logo} alt="NUB Logo" className=" w-10 h-10 md:h-24 mb-4 " />
            <hr className='w-full mb-5' />
            
            
            <NavLink to="/user" className="flex items-center gap-2 border-2 p-2 rounded-2xl mb-4">
              <img
